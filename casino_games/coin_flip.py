...
def play(active_terminal: Terminal, bet: int, turn: int):
    """
    Coin Flip
    ...
    choice = input(c.backYELLOW+c.BLACK+f"\rPlayer {turn}: Heads or Tails? (h/T) ")
    ss.overwrite("\r" + " " * 40)
    ...
    if(choice.lower() == "h" and flip == 'heads'):
        input(c.backYELLOW+c.BLACK+f"\rPlayer {turn}: You got heads!")
        ss.overwrite("\r" + " " * 40)
        score[0] += 1
    elif(choice.lower() == "h" and flip == 'tails'):
        input(c.backYELLOW+c.BLACK+f"\rPlayer {turn}: You got tails...")
        ss.overwrite("\r" + " " * 40)
    elif(flip == 'heads'):
        input(c.backYELLOW+c.BLACK+f"\rPlayer {turn}: You got heads...")
        ss.overwrite("\r" + " " * 40)
