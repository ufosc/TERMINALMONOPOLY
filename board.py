...
class Board:
    ...
    def update_location(self, player:m.Player, roll: int, new = None) -> None:
        """
        ...
        if(new == None):
            ...
            if new_location > 39:
                new_location -= 40
                player.receive(200)
                m.update_history(f"Player {player.order} passed Go and received $200")
    ...
    def current_location(self, player:m.Player) -> int:
        """
